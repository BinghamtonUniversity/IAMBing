...
class PublicAPIController extends Controller {
    ...
    public function update_group_members(Request $request, $name) {
        ...
        foreach($apigroup_users as $api_user) {
        ...
        //         $user = User::whereHas('group_memberships', function ($query) use ($group) {
        //             $query->where('group_id',$group->id);
        //         })->whereHas('user_unique_ids', function ($query) use ($apigroup_user,$unique_id) {
        //             $query->where('name',$unique_id)->where('value',$apigroup_user['ids'][$unique_id]);
        //         })->first();        
        //         if (!is_null($user)) {
