    ...
    schema:[
        ...
        new gform({
            ...
            "fields": [
                ...
                {name:"override_expiration",required:true, "label":"Manual Override Expiration",type:"date",format:{input: "YYYY-MM-DD"},help:'This manual override will be enforced until the date specified, at which point it will be updated or deleted by this user\'s calculated entitlements'},
